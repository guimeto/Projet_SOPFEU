...
#dset=Dataset('K:/PROJETS/PROJET_FIRE_INDEX/ERA5_FWI_Netcdf/ERA5_SR_QC1_2018_from_4_to_8.nc')
#dset=Dataset('K:/PROJETS/PROJET_FIRE_INDEX/ERA5_FWI_Netcdf/ERA5_SR_QC_SNOW1old_2018_from_4_to_8.nc')
dset=Dataset('K:/PROJETS/PROJET_FIRE_INDEX/ERA5_FWI_Netcdf/ERA5_SR_QC_SNOW_New_2018_from_4_to_8.nc')


year = 2018
## Lecture du fichier 
var=dset.variables['FWI'][:]
...
plt.savefig('./figures/SR_New_April_August_2018.png', bbox_inches='tight', pad_inches=0.1)
plt.show()  
plt.close()
