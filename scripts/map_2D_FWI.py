...
dset=Dataset('K:/PROJETS/PROJET_FIRE_INDEX/ERA5_FWI_Netcdf/ERA5_FWI_QC_SNOW_New_2018_from_4_to_8.nc')
...
string_title=u'Fire Weather Index ERA5 UQAM: '+dtime[index_to_find].strftime("%Y-%m-%d") 
plt.title(string_title, size='xx-large')
plt.savefig('./figures/FWI_'+dtime[index_to_find].strftime("%Y-%m-%d")+'.png', bbox_inches='tight', pad_inches=0.1)
plt.show()  
plt.close()
