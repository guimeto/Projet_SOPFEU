...
for year in range(yi,yf+1):
    ...
    file = 'J:/REANALYSES/ERA5/HR/ERA5_QC_TC_HR_WIND_'+str(year)
    ...
    # ecriture du Netcdf
    data_set.to_netcdf('K:/PROJETS/PROJET_FIRE_INDEX/ERA5_FWI_Netcdf/ERA5_FWI_QC_SNOW_'+str(year)+'_from_'+str(dtime[0].month)+'_to_'+str(dtime[nt].month)+'.nc')
    ...
    SR.to_netcdf('K:/PROJETS/PROJET_FIRE_INDEX/ERA5_FWI_Netcdf/ERA5_SR_QC_SNOW_'+str(year)+'_from_'+str(dtime[0].month)+'_to_'+str(dtime[nt].month)+'.nc')
    ds1.close()
    del [data_set, SR] 
