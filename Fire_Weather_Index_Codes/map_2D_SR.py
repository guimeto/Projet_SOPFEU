...
dset=Dataset('K:/PROJETS/PROJET_FIRE_INDEX/ERA5_FWI_Netcdf/ERA5_SR_QC_SNOW_2018_from_4_to_8.nc')
year = 2018
## Lecture du fichier 
...
plt.savefig('./SR_April_August_2018.png', bbox_inches='tight', pad_inches=0.1)
plt.show()  
plt.close()
